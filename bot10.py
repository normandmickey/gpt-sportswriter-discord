...
async def prediction_command(
  ...
  embed=discord.Embed(title=f"{game}", url="https://record.revmasters.com/_8ejz3pKmFDuMKNOJN2Xw7mNd7ZgqdRLk/1/",description=prediction, thumbnail="https://media.revmasters.com/uploads/002xnbaseason24-970x250-aff.gif")
  await ctx.defer() 
